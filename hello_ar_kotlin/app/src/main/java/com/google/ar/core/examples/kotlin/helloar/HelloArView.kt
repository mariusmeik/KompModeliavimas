...
class HelloArView(val activity: HelloArActivity) : DefaultLifecycleObserver {
  ...
  public fun pasirinktiVeikeja() {
    val textView: TextView = root.findViewById(R.id.Lapelis) as TextView
    textView.text = "models/MyModels/Lektuvelis.obj"
    val sharedPref = activity.getPreferences(Context.MODE_PRIVATE)
    val editor = sharedPref?.edit()
    editor?.remove("a")
    editor?.putString("a", "models/MyModels/Lektuvelis.obj")
    editor?.apply()
  }
  public fun pasirinktiLabirinta() {
    val textView: TextView = root.findViewById(R.id.Lapelis) as TextView
    textView.text = "models/MyModels/Labirintas.obj"
    val sharedPref = activity.getPreferences(Context.MODE_PRIVATE)
    val editor = sharedPref?.edit()
    editor?.remove("a")
    editor?.putString("a", "models/MyModels/Labirintas.obj")
    editor?.apply()
  }
